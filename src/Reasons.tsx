import { LockOpen, SearchCheck, Zap } from "lucide-react";
        ...
        <div className="mt-14 grid gap-6 lg:mt-20 lg:grid-cols-3">
          <div className="rounded-lg bg-accent p-5">
            ...
            <p className="leading-7 text-muted-foreground">
              Our advanced checker guarantees 100% detection of compromised
              private keys. In short: no false negatives.
            </p>
          </div>
          <div className="rounded-lg bg-accent p-5">
            <span className="mb-8 flex size-12 items-center justify-center rounded-full bg-background">
            ...
            <p className="leading-7 text-muted-foreground">
              We follow industry-leading standards to ensure your private key is
              handled appropriatly. We work accirdingly to DIN 820-5 and ISO
              3103.
            </p>
          </div>
          <div className="rounded-lg bg-accent p-5">
            ...
            <p className="leading-7 text-muted-foreground">
              No waiting, no delays. Find out immediately if your private key
